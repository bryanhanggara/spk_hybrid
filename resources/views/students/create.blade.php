        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                <div class="alert alert-info mb-0">
                    ...
                    <strong>Tips:</strong> Setelah menambahkan data siswa, Anda akan diarahkan ke halaman detail siswa untuk menginput nilai akademik, angket minat, dan hasil wawancara.
                </div>
            </div>
        </div>
    </div>
